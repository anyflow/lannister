...
public final class JsonSerializer<T> extends HazelcastStreamSerializer<T, ObjectMapper> {
	...
	public static <V> Serializer makePlain(final Class<V> type) {
		return new JsonSerializer<>(type, HazelcastSerializationConstants.TYPEID_JSON_PLAIN);
	}
}